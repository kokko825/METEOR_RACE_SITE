...
export default function PrivacyPage() {
  return (
    <main className="doc-page">
      ...
      <section className="doc-section"><h2>保存期間</h2><p>チャットは最長30日、お問い合わせは原則180日を目安に自動削除します。法令対応、不正利用調査、紛争対応に必要な場合は、その目的に必要な期間に限り保存することがあります。</p></section>
      <section className="doc-section"><h2>お問い合わせ</h2><p>削除依頼や質問は、ゲーム内のSETTINGSにあるお問い合わせフォームから送信してください。</p></section>
      <p className="doc-updated">制定日：2026年8月20日　最終更新：2026年8月25日</p>
    </main>
  );
}
