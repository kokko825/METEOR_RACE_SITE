...
export default function PrivacyPage() {
  return (
    <main className="doc-page">
      ...
      <section className="doc-section"><h2>匿名の好プレーデータ</h2><p>設定がONの場合、CPUを含む対戦で勝者が行った有効性の高い局面を、AI改善の検証資料として保存することがあります。盤面、モード、難易度、行動前後の状態を保存しますが、ニックネーム、メールアドレス、チャット、PLAYER ID、ルームコードは含めず、別の対戦と同一人物として結び付けません。AIが自動学習するためには使用せず、設定からいつでもOFFにできます。</p></section>
