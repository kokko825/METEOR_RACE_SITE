...
export default function PrivacyPage() {
  return (
    <main className="doc-page">
      ...
      <section className="doc-section"><h2>保存する情報</h2><p>ニックネーム、端末ごとの内部識別子と、それから作る短いREGULA企業登録番号、対戦結果、レート、ルーム参加情報、ルームチャット、お問い合わせ内容を保存することがあります。認証サービスと連携した場合に限り、識別と問い合わせ通知のためメールアドレスを取り扱う場合があります。</p></section>
      ...
      <section className="doc-section"><h2>公開範囲</h2><p>他のプレイヤーに表示するのは対戦用ニックネームなど、ゲームに必要な情報だけです。内部識別子は公開せず、設定画面やお問い合わせには短いREGULA企業登録番号だけを使用します。</p></section>
