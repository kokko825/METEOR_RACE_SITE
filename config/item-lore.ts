...
export const ITEM_LORE = [
  ...
  { kind: "recall", company: "ANCHOR LOGISTICS", ja: "軌道上の採掘機材を遠隔回収する物流システム。競技衛星と連携し、自社が展開した装備だけを識別・回収。", en: "An orbital logistics system for remotely retrieving mining equipment. It identifies and recovers only gear deployed by its own corporation." },
] as const;
