...
for (const file of ["app/game-rules.ts", "tests/switch-battle.test.ts"]) {
...
await import(`${pathToFileURL(path.join(output, "tests/switch-battle.test.js")).href}?t=${Date.now()}`);
